  ...
  <div class="text-center" style="max-width:640px;margin:0 auto;padding:60px 20px;">
    ...
    <div class="famako-card p-4 mb-4" style="border-top:4px solid var(--accent);">
      <p style="font-size:1.05rem;color:var(--navy);font-weight:600;margin-bottom:12px;">
        <i class="fas fa-graduation-cap me-2" style="color:var(--accent)"></i>
      ...
      <p style="color:var(--muted);font-size:.92rem;line-height:1.7;margin-bottom:0;">
        <span data-lang="fr">Les cours et ressources pédagogiques de la Faculté Maïngo Ködörö sont accessibles uniquement aux étudiant·e·s régulièrement inscrit·e·s. Pour accéder à ces contenus, vous devez être inscrit·e et avoir reçu vos codes d'accès de l'administration.</span>
        <span data-lang="en">Courses and educational resources of Maïngo Ködörö Faculty are accessible only to regularly enrolled students. To access this content, you must be enrolled and have received your access codes from the administration.</span>
      </p>
    </div>
